...
const LINKS_FILE_PATH = path.resolve('data/i4/used-links.json')
const CARS_FILE_PATH = path.resolve('data/i4/used.json')
...
async function getLinks() {
  try {
    ...
    const initialResponse = await fetch(
      'https://bmwpremiumselection.be/nl/?aj=1&s=1&v[]=118&co2min=0&co2max=290&monthlymin=0&monthlymax=0&pmin=0&pmax=180000&kmin=0&kmax=132661&imin=2005&imax=2025&chmin=0&chmax=748&kwmin=0&kwmax=550&pw=ch&l=0&radius=0&zipcode=0',
    )
